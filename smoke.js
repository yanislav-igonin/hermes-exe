...
const ctxStub = { createLinearGradient: () => ({ addColorStop() {} }), createRadialGradient: () => ({ addColorStop() {} }), createImageData: (w, h) => ({ data: new Uint8ClampedArray(w * h * 4) }), putImageData() {}, drawImage() {}, clearRect() {}, beginPath() {}, arc() {}, fill() {}, stroke() {}, moveTo() {}, lineTo() {}, closePath() {}, fillRect() {}, strokeRect() {}, fillText() {}, ellipse() {}, globalAlpha: 1, save() {}, restore() {}, getImageData: () => ({ data: new Uint8ClampedArray(0) }), strokeStyle: "", fillStyle: "", lineWidth: 0 };
