...
const htmlCanvas = () => ({ width: 0, height: 0, style: {}, getContext: () => ({ createImageData: (w, h) => ({ data: new Uint8ClampedArray(w * h * 4) }), putImageData() {}, drawImage() {}, clearRect() {}, beginPath() {}, arc() {}, fill() {}, stroke() {}, moveTo() {}, lineTo() {}, closePath() {}, fillRect() {}, getImageData: () => ({ data: new Uint8ClampedArray(0) }), strokeStyle: "", fillStyle: "", lineWidth: 0 }) });
const ctxStub = { createImageData: (w, h) => ({ data: new Uint8ClampedArray(w * h * 4) }), putImageData() {}, drawImage() {}, clearRect() {}, beginPath() {}, arc() {}, fill() {}, stroke() {}, moveTo() {}, lineTo() {}, closePath() {}, fillRect() {}, getImageData: () => ({ data: new Uint8ClampedArray(0) }), strokeStyle: "", fillStyle: "", lineWidth: 0 };
...
try {
  ...
  console.error("MAIN.JS THREW:", e.stack.split(String.fromCharCode(10)).slice(0,6).join(String.fromCharCode(10)));
  process.exit(1);
}
